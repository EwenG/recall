(function recallBootstrap(window) {
  ...
  {
    var localRoot = path.join(lt.objs.plugins.user_plugins_dir, 'recall'); //When recall is manually cloned from the repository, the recall folder is created with a lower case
  }
